...
#define DeferLoop(CodeA, CodeB) for (bool32 ConcatLine(_Loop) = true; ConcatLine(_Loop) ? (CodeA, true) : false; CodeB, ConcatLine(_Loop) = false)
...
#define DLLPushFront(First, Last, Element) DLLPushBack_Named(Last, First, Element, Previous, Next)
