...
#define CheckErrorGoto(ErrorFlag, Label, Type, ...) if (ErrorFlag) { LogError(Type, __VA_ARGS__); goto Label; }
#define CheckErrorGotoNoLog(ErrorFlag, Label) if (ErrorFlag) { goto Label; }
